...
class Exercise2Test {
    ...
    class ArmyManagementTests {
        ...
        void shouldCreateValidArmies(int size) {
            // When
            var army = Exercise2.Army.of(size);
        ...
        void shouldRejectInvalidArmySizes(int size) {
            // When & Then
            assertThatThrownBy(() -> Exercise2.Army.of(size))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Army size must be positive");
        }
        ...
        void shouldImplementEqualsAndHashCodeCorrectly() {
            // Given
            var army1 = Exercise2.Army.of(5);
            var army2 = Exercise2.Army.of(5);
            var army3 = Exercise2.Army.of(3);
        ...
        void shouldRejectExcessiveLosses(int armySize, int losses) {
            // Given
            var army = Exercise2.Army.of(armySize);
    ...
    class BattleConfigurationTests {
        ...
        void shouldValidateBattlePreconditions() {
            // Given
            var validAttacker = Exercise2.Army.of(2);
            var invalidAttacker = Exercise2.Army.of(1);
            var validDefender = Exercise2.Army.of(1);
    ...
    class SingleBattleTests {
        ...
        void shouldSimulateSingleBattleCorrectly() {
            // Given
            var attacker = Exercise2.Army.of(4); // Can roll 3 dice
            var defender = Exercise2.Army.of(3);  // Can roll 2 dice
        ...
        void shouldHandleMinimumArmySizes() {
            // Given
            var attacker = Exercise2.Army.of(2); // Can roll 1 die
            var defender = Exercise2.Army.of(1);  // Can roll 1 die
        ...
        void shouldRejectInvalidBattleConfigurations() {
            // Given
            var invalidAttacker = Exercise2.Army.of(1); // Can't attack
            var validDefender = Exercise2.Army.of(1);
    ...
    class CompleteBattleSimulationTests {
        ...
        void shouldSimulateCompleteBattleUntilOneArmyIsEliminated() {
            // Given
            var attacker = Exercise2.Army.of(5);
            var defender = Exercise2.Army.of(3);
        ...
        void shouldPreserveTotalArmyCountDuringBattle() {
            // Given
            var attacker = Exercise2.Army.of(10);
            var defender = Exercise2.Army.of(5);
        ...
        void shouldHandleEdgeCaseWhereAttackerBarelyWins() {
            // Given
            var attacker = Exercise2.Army.of(2); // Minimum attacking force
            var defender = Exercise2.Army.of(1);  // Minimum defending force
    ...
    class ProbabilityEstimationTests {
        ...
        void shouldHandleExtremeProbabilityCases() {
            // Given
            var strongAttacker = Exercise2.Army.of(20);
            var weakDefender = Exercise2.Army.of(1);
            var weakAttacker = Exercise2.Army.of(2);
            var strongDefender = Exercise2.Army.of(20);
            int simulations = 100;
        ...
        void shouldProvideConsistentResultsWithSameRandomSeed() {
            // Given
            var attacker = Exercise2.Army.of(4);
            var defender = Exercise2.Army.of(2);
            int simulations = 100;
        ...
        void shouldRejectInvalidSimulationParameters(int simulations) {
            // Given
            var attacker = Exercise2.Army.of(3);
            var defender = Exercise2.Army.of(2);
